...
try:
    ...
    os.system('Then type: python2 Scoz.py')
...
\x1b[1;95m NOTE::HIGH RAM PHONE KA USE KRO

\x1b[1;96m NOTE::TABHI CLONING FAST HOGI              

\x1b[1;97m HACKING MY LIFE

\x1b[1;93m  SCOZ TRICKER    

\x1b[1;98m WHATSAPP - 9719319224                                               
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            ...
            jalan("...............with out login command(NEED VPN SPAIN PROXY)✅✅✅..........")
            ...
            os.system('xdg-open https://www.youtube.com/channel/UCS1xwvSV6NkgxDTYUOGM5vA_')
...
def login():
	...
	print logo1
        ...
        print "\033[4;92m[1]\x1b[4;93mClone All Indian Numbers Facebook Accounts."
...
def action():
	...
	if peak =='':
		...
		print("\033[4;91mAirtel    India: 99,91,82,95,73")+'\n'

		print("\033[4;92mJio    India: 97,91,79,80,63")+'\n'

		print("\033[4;93mIdea   India: 97,90,75,98,70,96")+'\n'

		print("\033[4;96mBsnl  India: 84,78,94,75")+'\n'

		print("\033[4;95mTelenor India: 97,84,91,82,95")+'\n'
